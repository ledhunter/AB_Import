...
**Статус**: 🟢 v0.2 готова — парсер секции, маппер Title→Code, идемпотентный apply (find/create/patch).
**Дата**: 2026-05-08
**Связано с**: [70-wbs-api-foundation.md](70-wbs-api-foundation.md) (фундамент клиента WBS).
