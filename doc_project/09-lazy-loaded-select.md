...
> 📝 С версии «библиотека ListView» вся эта state-машина вынесена в generic-хук
> `useListView`, см. [10-listview-library.md](./10-listview-library.md). Если
> в новом хуке хранишь «latest query» в ref'е — обязательно прочитай
> [11-react-refs-discipline.md](./11-react-refs-discipline.md) (правило записи
> `ref.current` только в `useEffect`, не в фазе рендера).
