...
public class ImportTypesController : ControllerBase
{
    ...
    public IActionResult List()
    {
        ...
        {
            ["rooms"]            = ("Помещения",          "Импорт реестра помещений (квартир, машиномест, кладовых) по шаблону «Пример импорта.xlsx» / «Единая форма 3» — Site/Section/Room/ДДУ через Visary API"),
